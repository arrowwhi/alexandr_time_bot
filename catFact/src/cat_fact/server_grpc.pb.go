...
const (
	CatFactService_GetResponse_FullMethodName = "/cat_fact.CatFactService/GetResponse"
)
...
type CatFactServiceClient interface {
	GetResponse(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *catFactServiceClient) GetResponse(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, CatFactService_GetResponse_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CatFactServiceServer interface {
	GetResponse(context.Context, *EmptyRequest) (*Response, error)
...
func (UnimplementedCatFactServiceServer) GetResponse(context.Context, *EmptyRequest) (*Response, error) {
...
func _CatFactService_GetResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatFactServiceServer).GetResponse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatFactService_GetResponse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatFactServiceServer).GetResponse(ctx, req.(*EmptyRequest))
	}
...
var CatFactService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cat_fact.CatFactService",
	HandlerType: (*CatFactServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetResponse",
			Handler:    _CatFactService_GetResponse_Handler,
		},
	},
